# DataFi - Atomic NFTs (Market)

_What if you could sell your Atomic NFT within the NFT?_

DataFi, Atomic NFTs are powerful mechanisms that connect together three Arweave technologies, SmartWeave contracts, Atomic NFTs and the Permaweb. In this workshop, we will modify the Dynamic NFT, by adding the ability to purchase the NFT within the NFT itself. By using the Arweave confirmation cycle, we can prevent duplicate spend problem and create a secure transfer of ownership of the NFT. 

``` 
As a user, I want to click the 'Buy Now' button and purchase the NFT in a single session.
```

Dynamic Atomic NFTs are SmartWeave Contracts wrapped around a Permaweb App that wraps a digital asset, this capability allows for many interesting use cases. One use case is the ability for the NFT itself to actually capture attention and work with L2 blockchains like `KOII` to provide rewards for that attention. 
...
## Workshop Project Buy Atomic NFT

Steps

1. Create creates Atomic NFT
2. Lists the NFT for Sale with a price as type Buy Now
3. Buyer views NFT, sees price and clicks Buy Now
4. Transaction Locks NFT in purchasing state and app waits for 10 confirmations
5. app requests buyer to confirm purchase: which writes an interaction with target and winstonQty set
6. contract checks that target matches owner and qty matches price if so, updates state with new owner
7. app waits 10 confirmations before showing successful transfer

Happy Path 

![Happy Path](https://www.websequencediagrams.com/cgi-bin/cdraw?lz=&s=default)

Cancel Path

![CancelPath](https://www.websequencediagrams.com/cgi-bin/cdraw?lz=&s=default)
...
```
git clone https://github.com/twilson63/datafi-buynow-atomic-nfts
cd datafi-buynow-atomic-nfts
```
